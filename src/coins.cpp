...
void CCoinsViewCache::AddCoin(const COutPoint &outpoint, Coin&& coin, bool possible_overwrite, bool allow_unspendable) {
    assert(!coin.IsSpent());
    if (!allow_unspendable && coin.out.scriptPubKey.IsUnspendable()) return;
